...
function goLecture(prevuri)
{	
	showWin(prevuri, 'modwin', 1024, 768);
	return;
...
<body>
<div id="right_bg"></div>
<div style="position: relative; width: 1000px; margin: 0 auto; background: #303030;"><a href="/home"><img src="/home/images2/common/tab1_off.gif"/></a><a href="/home/index2.main2.action"><img src="/home/images2/common/tab2_on.gif"/></a></div>
...
<%--             <a href="<%=PageUrl114%>"><img src="/home/images3/common/txt_cyber.png" alt="사이버대학연혁" /></a> --%>
        ...
        <div class="cyber_gnb">
        	<div class="cyber_menu_div">
                <h2><a href="#"><img src="/home/images3/common/gnb/h2_txt1.png" alt="우리는 사이버세계로 대학간다" /></a></h2>
                <ul class="cyber_ul">
       		...
       		<div class="btn"><a href="#"><img src="/home/images3/common/gnb/btn_cyber.png" alt="사이버 대학" /></a></div>
