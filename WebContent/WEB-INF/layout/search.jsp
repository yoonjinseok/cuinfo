...
if(cate_int == 114){SubTitle="사이버대학이란?";		TitleImg="title1";	SnbOn11="on"; SnbOn114="on"; PageUrl = "/home/intro/yearHistory.sub.action?gnb=114";	}
...
//3.전체학과검색
String SnbNmae33  	= "전체 교과과정";				String PageUrl33	= "/home/curri/searchMajor.sub.action?gnb=33";
...
if(cate_int == 52) {SubTitle="사이버대학 뉴스";				TitleImg="title2";	SnbOn52="on";				 PageUrl = "/home/refer/boardNews.sub.action?gnb=52";     	}
...
//	 		$("left#gnb .depth2_div ul").css("display","none");
    ...
    window.onload = function(){
    	...
    	//통합검색
    	tabClick(<%=request.getParameter("searchGubn")%>);
    	selectSearchGubnItem(<%=request.getParameter("searchGubn")%>);
    	selectSearchGubn();
    };
	...
	function headerSearch(page)
	{
    	...
    	//키워드 클릭 수 입력
    	///home/search/keyword_save.ajax.action'
    ...
    function tabClick(no)
    {
    	...
    	*/
    	$("#showDiv1,#showDiv2,#showDiv3").hide();
		...
		switch(parseInt(no))
		{
			case 0:
				...
				$("#showDiv1,#showDiv2,#showDiv3").show();
				$("#pg2").hide();
    ...
    function viewDetail1(courseId,courseIdentifier, title)
	{
    	...
    	document.location.href = '/home/course/courseSearchView.sub.action?gnb=31&courseId='+courseId+'&hidetext='+escape(encodeURIComponent(title));
...
<div style="position: relative; width: 1006px; margin: 0 auto; "><a href="/home"><img src="/home/images2/common/tab1_on.gif"/></a><a href="/home/index2.main2.action"><img src="/home/images2/common/tab2_off.gif"/></a></div>
...
<div id="leftgnb">
        ...
        <ul class="ul_depth1">
        	<li><a href="#"><img src="/home/images2/common/gnb/gnb1.png" alt="사이버대학 안내" /></a></li>
            <li><a href="#"><img src="/home/images2/common/gnb/gnb2.png" alt="입학안내" /></a></li>
            <li><a href="#"><img src="/home/images2/common/gnb/gnb3.png" alt="교과과정" /></a></li>
            <li><a href="#"><img src="/home/images2/common/gnb/gnb4.png" alt="강의 검색" /></a></li>
            <li><a href="#"><img src="/home/images2/common/gnb/gnb5.png" alt="정보 자료실" /></a></li>
        </ul>
        ...
        <div class="search">
			...
			<input type="hidden" id="searchGubn2" name="searchGubn" value="<%=request.getParameter("searchGubn")%>" />
			<input type="hidden" id="searchGubn" name="searchGubn" value="0" />
            	<fieldset class="hdd">검색</fieldset>
                <input type="text" class="keyword" value="<%=request.getParameter("headerText")%>" id="headerText" name="headerText" onFocus="if(this.value == 'SEARCH') this.value=''"/><input type="image" src="/home/images2/common/search_btn.gif" onclick="javascript:headerSearch();"/>
            </form>
        ...
        <div class="depth2_div" style="opacity:0.8;">
            ...
            <ul class="sub0">
                <li><a href="#"><img src="/home/images2/common/gnb/m_d1_1_0_off.png" alt="사이버대학이란?"/></a>
                	<ul>
                ...
                <li><a href="#"><img src="/home/images2/common/gnb/m_d1_4_0_off.png" alt="학위취득/국가자격증"/></a>
                	<ul>
                ...
                <li><a href="#"><img src="/home/images2/common/gnb/m_d1_5_0_off.png" alt="진학가이드"/></a>
                    <ul>
             ...
             <ul class="sub1">
                <li><a href="#"><img src="/home/images2/common/gnb/m_d2_1_0_off.png" alt="입학 구분 및 절차"/></a>
                	<ul>
        ...
        <div class="cyber_gnb">
        	<div class="cyber_menu_div">
                ...
                <ul class="cyber_ul">
                     <li><img height="50%" src="/home/images2/common/gnb/m_cy_1.png" alt="건양사이버대학교"  onclick="showWinlocation('http://www.kycu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_2.png" alt="경희사이버대학교" onclick="showWinlocation('http://www.khcu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_3.png" alt="고려사이버대학교" onclick="showWinlocation('http://www.cuk.edu', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_4.png" alt="국제사이버대학교" onclick="showWinlocation('http://www.gcu.ac/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_5.png" alt="글로벌사이버대학교" onclick="showWinlocation('http://www.global.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_6.png" alt="대구사이버대학교" onclick="showWinlocation('http://www.dcu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_N01.png" alt="디지털서울문예대학교"onclick="showWinlocation('http://www.scau.ac.kr/', '', 800, 550);" style="cursor: pointer" /></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_9.png" alt="부산디지털대학교" onclick="showWinlocation('http://www.bdu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_N02.png" alt="사이버한국외국어대학교" onclick="showWinlocation('http://www.cufs.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_11.png" alt="서울디지털대학교" onclick="showWinlocation('http://www.sdu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_12.png" alt="서울사이버대학교" onclick="showWinlocation('http://www.iscu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_N03.png" alt="세계사이버대학" onclick="showWinlocation('http://www.world.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_13.png" alt="세종사이버대학교" onclick="showWinlocation('http://portal.sjcu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_14.png" alt="숭실사이버대학교" onclick="showWinlocation('http://www.kcu.ac/', '', 800, 550);" style="cursor: pointer"/></li>
                    
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_N04.png" alt="영남사이버대학교" onclick="showWinlocation('http://www.yncu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_N05.png" alt="영진사이버대학" onclick="showWinlocation('http://www.ycc.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_18.png" alt="원광디지털대학교" onclick="showWinlocation('http://www.wdu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_N06.png" alt="한국복지사이버대학교" onclick="showWinlocation('http://www.corea.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_15.png" alt="열린사이버대학교" onclick="showWinlocation('http://www.ocu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_20.png" alt="한양사이버대학교" onclick="showWinlocation('http://www.hanyangcyber.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                    <li><img height="50%" src="/home/images2/common/gnb/m_cy_21.png" alt="화신사이버대학교" onclick="showWinlocation('http://www.hscu.ac.kr/', '', 800, 550);" style="cursor: pointer"/></li>
                </ul>
            </div>
